...
'''
import os
from src.descriptive_stats import get_descriptive_stats, get_species_stats, generate_plots, generate_markdown
...
def test_plots():
    ...
    '''
    generate_plots()
    assert os.path.exists("/workspaces/ci-python-data-science/img/species_distribution.png")
    assert os.path.exists("/workspaces/ci-python-data-science/img/density_relationship.png")
